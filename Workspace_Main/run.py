...
def main():
    ...
    parser.add_argument("--seq2seq_model_dir",
                        default=BASE_DIR + '\\Workspace_Main\\ckpt\\seq2seq', help="Model folder")
    parser.add_argument("--model_path", help="Path to a specific model", default="", type=str)
    parser.add_argument("--train_seg_x_dir",
                        default=BASE_DIR + '\\Workspace_Main\\data\\train_set.seg_x.txt',
                        help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir",
                        default=BASE_DIR + '\\Workspace_Main\\data\\train_set.seg_y.txt',
                        help="train_seg_y_dir")
    parser.add_argument("--test_seg_x_dir",
                        default=BASE_DIR + '\\Workspace_Main\\data\\test_set.seg_x.txt',
                        help="test_seg_x_dir")
    parser.add_argument("--vocab_path", default=BASE_DIR + '\\Workspace_Main\\data\\vocab.txt',
                        help="Vocab path")
    parser.add_argument("--word2vec_output",
                        default=BASE_DIR + '\\Workspace_Main\\data\\word2vec.txt',
                        help="Vocab path")
    parser.add_argument("--test_save_dir", default=BASE_DIR + '\\Workspace_Main\\data\\',
                        help="test_save_dir")
