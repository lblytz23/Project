...
import argparse
import NLG_Baidu.training as training
# import pathlib
...
def main():
    ...
    print(BASE_DIR)
    parser.add_argument("--seq2seq_model_dir",
                        default=BASE_DIR + '\\NLG_Baidu\\ckpt\\seq2seq', help="Model folder")
    parser.add_argument("--model_path", help="Path to a specific model", default="", type=str)
    parser.add_argument("--train_seg_x_dir",
                        default=BASE_DIR + '\\NLG_Baidu\\data\\train_set.seg_x.txt',
                        help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir",
                        default=BASE_DIR + '\\NLG_Baidu\\data\\train_set.seg_y.txt',
                        help="train_seg_y_dir")
    parser.add_argument("--test_seg_x_dir",
                        default=BASE_DIR + '\\NLG_Baidu\\data\\test_set.seg_x.txt',
                        help="test_seg_x_dir")
    parser.add_argument("--vocab_path", default=BASE_DIR + '\\NLG_Baidu\\data\\vocab.txt',
                        help="Vocab path")
    parser.add_argument("--word2vec_output",
                        default=BASE_DIR + '\\NLG_Baidu\\data\\word2vec.txt',
                        help="Vocab path")
    parser.add_argument("--test_save_dir", default=BASE_DIR + '\\NLG_Baidu\\data\\',
                        help="test_save_dir")
